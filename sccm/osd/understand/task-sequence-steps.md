 ...
 **Place into the following location**  
 ...
 -   **Custom path**  
> [!NOTE]
> When you choose a **Custom Path** step, the content is first downloaded to the task sequence package cache, then _moved_ to the custom path with the Package ID appended.
